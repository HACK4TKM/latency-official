		...
		<div className="backgroundsv  bg-opacity-50">
			...
			<div
				...
				<div className="px-2 py-1 -mx-3 ">
					...
					<div className="mx-2">
						<span className="font-semibold text-white text-sm px-2">Rules & guidelines</span>
					</div>
					</a>
				</div>
			</div>
			...
			>
				...
				<div className="flex mb-10 bg-black bg-opacity-20 shadow-lg rounded-xl w-2/3 px-8 py-4 flex-col items-center ">
					<div className=" bg-gray-200  hover:bg-purpleC rounded-full  m-2 mx-4">
					...
					<p className="text-center text-white text-xs">{"Micro.Company"}</p>
